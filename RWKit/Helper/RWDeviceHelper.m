...
//  Test1129
//
//  Created by RangerChiong on 16/11/29.
//  Copyright © 2016年 Ranger. All rights reserved.
//

#import "RWDeviceHelper.h"
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <unistd.h>
...
+ (NSString *)ipAddr {
    ...
    GetIPAddresses();
    GetHWAddresses();
    NSString *ipAddr = [NSString stringWithFormat:@"%s", ip_names[1]];
    FreeAddresses();
    return ipAddr;
}

#pragma mark-  ip address function
